...
# docker build -t revenger .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name revenger revenger
...
COPY Gemfile Gemfile.lock vendor mise.toml ./
