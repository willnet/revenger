...
window.JST['posts/post'] = function(context) {
  const post = context.post;
  return '<div class="view" data-behavior="view-element">' +
         ...
         '</div>' +
         '<div class="edit" data-behavior="edit-element">' +
         '  <span class="duration btn-group" data-toggle="buttons-radio" data-behavior="duration">' +
